...
import com.kinglian.screeninquiry.model.dto.WeChatParams;
...
public class WeixinPay {
    ...
    public static String getCodeUrl(WeChatParams ps) throws Exception {
         ...
         * 账号信息
         */
        String appid = "wx08e2ea07eefdc16e";//微信服务号的appid
        String mch_id ="1491684712"; //微信支付商户号
        String key = "Hxinjingling0951797833333333333h";// 微信支付的API密钥
        String notify_url = "http://yun.kinglian.cn/ehr.payment/payment/wxpay/appPayNotifyPage.aspx";//回调地址【注意，这里必须要使用外网的地址】
        ...
        packageParams.put("out_trade_no", ps.out_trade_no);//商户订单号【备注：每次发起请求都需要随机的字符串，否则失败。】
    ...
    public static String getPayState(WeChatParams ps) throws Exception {
        /**
         * 账号信息
         */
        String appid = "wx08e2ea07eefdc16e";//微信服务号的appid
        ...
        String key = "Hxinjingling0951797833333333333h";// 微信支付的API密钥
        String notify_url = "http://yun.kinglian.cn/ehr.payment/payment/wxpay/appPayNotifyPage.aspx";//回调地址【注意，这里必须要使用外网的地址】
        String ufdoder_url="https://api.mch.weixin.qq.com/pay/orderquery";//微信下单API地址
        String trade_type = "NATIVE"; //类型【网页扫码支付】
